...
public static class Settings
{
    ...
    public const int daysToSeason = 30;
    public const int seasonsToYear = 4;
    public const int maxYear = 10000;
    //public const string[] DaysOfWeek = { "", "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" };
